...
export default function Refrigeradoras() {
    return (
        <section className='text-gray-800 flex-1'>
            ...
            <section className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10'>
                ...
                <article className='flex flex-col justify-between'>
                    ...
                    <div>
                        <h2 className='font-semibold'>Refrigeradora Indurama Top Mount</h2>
                ...
                <article className='flex flex-col justify-between'>
                    ...
                    <div>
                        <h2 className='font-semibold'>Refrigeradora Electrolux Top Mounto</h2>
