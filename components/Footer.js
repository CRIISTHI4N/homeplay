    ...
    return (
        <footer className='w-full bg-[#131114]' id='footer'>
            ...
            <div className='w-[80%] m-auto border-b border-gray-700 py-10'>
                ...
                <p className='text-center text-xl bg-gradient-to-l from-[#ffbe0d] to-[#ff0000] text-transparent bg-clip-text font-bold'>Tecnología y
                    Hogar Inteligente</p>
            </div>
            ...
            <div className="w-[80%] m-auto py-7 grid grid-cols-1 lg:grid-cols-3 gap-7">
                ...
                <div>
                    ...
                    <p className="text-xl mb-2 font-bold labellock">
                        <span className="text-[#c94139]">HOME</span>
                        <span className="text-gray-100">PLAY</span>
                    </p>
            ...
            <div className='bg-[#1b181c] py-2'>
                ...
                <div className='w-[80%] m-auto flex justify-between items-center'>
                    <p className="text-center">Copyright © 2025 HomePlay. Todos los derechos reservados.</p>
