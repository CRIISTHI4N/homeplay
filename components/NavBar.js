...
export default function NavBar() {
    ...
    return (
        <nav className={`fixed top-8 left-[50%] translate-x-[-50%] z-20 w-[80%] m-auto bg-gradient-to-l from-red-500 to-[#c94139] p-2 lg:p-3 transition-transform duration-300 flex justify-between items-center shadow-md shadow-[#131114] border border-[#dc2e2e] ${isVisible ? "translate-y-0" : "-translate-y-[200%]"}`}>
            ...
            <div className="w-full flex justify-between items-center">
                <div className='flex items-center gap-2'>
                    ...
                    <p className='font-bold text-md lg:text-xl'>Home Play</p>
                </div>
                ...
                <ul className='hidden lg:flex items-center gap-1'>
                    <li>
                        <Link
                            href="/"
                            className={`block leading-none -skew-x-12 hover:bg-[#2c2c2c] transition-colors py-2 px-3 font-semibold ${pathname === '/' ? 'bg-[#2c2c2c]' : ''}`}
                        >
            ...
            {navBarActive ?
                <button
                    type="button"
                    className={`block lg:hidden leading-none -skew-x-12 hover:bg-[#2c2c2c] transition-colors py-2 px-3 font-semibold bg-red-500`}
            ...
            {/* <Link
                ...
                target="_blank"
                className="items-center gap-1 py-2 px-3 font-semibold bg-red-500 transition-colors text-gray-100 hidden lg:flex text-nowrap -skew-x-12"
            >
            ...
            <div className={`${navBarActive ? "translate-y-0" : "-translate-y-[200%]"} bg-gradient-to-l from-red-500 to-[#c94139] shadow-md shadow-[#131114] border border-[#dc2e2e] absolute top-20 left-[50%] -translate-x-[50%] p-2 transition-all duration-500`}>
                <ul className='flex flex-col items-center gap-1 text-nowrap text-sm lg:text-base'>
                    ...
                    {/* <li>
                        <Link
                            ...
                            target="_blank"
                            className="items-center gap-1 py-2 px-3 font-semibold bg-[#2c2c2c] transition-colors text-gray-100 flex text-nowrap -skew-x-12"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="icon icon-tabler icons-tabler-filled icon-tabler-user skew-x-12"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 2a5 5 0 1 1 -5 5l.005 -.217a5 5 0 0 1 4.995 -4.783z" /><path d="M14 14a5 5 0 0 1 5 5v1a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-1a5 5 0 0 1 5 -5h4z" /></svg>
                            <span className='block skew-x-12 leading-none'>Iniciar Sesión</span>
                        </Link>
